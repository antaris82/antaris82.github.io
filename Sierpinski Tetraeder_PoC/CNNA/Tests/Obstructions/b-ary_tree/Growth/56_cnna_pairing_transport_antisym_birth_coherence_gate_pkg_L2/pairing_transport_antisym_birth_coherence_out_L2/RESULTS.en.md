...
This is not a complex-structure derivation, nor is it a true `*` structure. It is a falsifiable diagnostic for the missing combination: local directed birth orientation + beta2 carrier + pairing/inter-fan transport.
