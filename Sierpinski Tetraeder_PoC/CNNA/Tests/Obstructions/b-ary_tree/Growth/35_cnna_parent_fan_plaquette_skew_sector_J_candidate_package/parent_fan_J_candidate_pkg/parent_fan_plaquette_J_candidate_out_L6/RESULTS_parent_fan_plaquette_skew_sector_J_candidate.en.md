...
This is the first J-near test following the face-level plaquette frustration and
...
carrier survives controls and exhibits the correct orientation behavior.
...
Even if these conditions hold, the result is still a local skew-sector J-candidate, not a
real *-algebra, not a C*-completion, and not a GNS/AQFT net.
