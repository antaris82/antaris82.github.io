...
This package checks whether the current nonlinear asymmetry-gated pairing rule overlooks beta2-opening candidates that have a better native C-pair even/odd J-lock.

It evaluates valid pairing candidates at each scan state before the current selection rule is applied.  The gate does not impose a new rotation and does not introduce i, Hodge, positivity, a physical adjoint, or a final symmetrization.
...
| real_growth_phase-1 | (1,0,2,0) | 2 | 13 | 9 | 1 | 0.173092 / 0.173092 | 0.212941 | False | 0.192677 |
