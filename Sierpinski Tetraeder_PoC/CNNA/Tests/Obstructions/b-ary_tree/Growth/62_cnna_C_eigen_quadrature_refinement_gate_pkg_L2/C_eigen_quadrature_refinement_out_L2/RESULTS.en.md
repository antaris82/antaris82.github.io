...
The test distinguishes between two possibilities:
...
A positive hit would require at least one beta2-opening candidate with both the mean and maximum C-eigen J-lock residuals below the configured thresholds.
