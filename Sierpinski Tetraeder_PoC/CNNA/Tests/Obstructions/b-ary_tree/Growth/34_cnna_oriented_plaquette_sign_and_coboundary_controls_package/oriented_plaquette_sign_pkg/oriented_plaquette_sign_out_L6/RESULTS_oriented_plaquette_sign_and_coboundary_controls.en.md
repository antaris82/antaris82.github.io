...
This test verifies the first simplicial DtN plaquette-frustration signal.

It still does **not** define `i`, `J`, a Hilbert space, a C*-norm, or a *-algebra.

## Key Questions

1. Orientation reversal: `(a,b,c)` versus `(a,c,b)` should flip the commutator/skew sign.
2. Coboundary controls: first-order edge circulation is exact and telescopes; diagonal, trace-scalar, and common-mean-diagonal ablations should eliminate any scalar/commuting explanation.
3. Face separation: sibling triangles and parent-fan triangles are maintained as distinct geometric carriers.
