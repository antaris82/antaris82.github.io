...
Interpret this conservatively: pair-graph and signed modes are diagnostic tools for determining whether the obstruction is compatible with phase propagation; they do not yet constitute a theorem stating that such propagation is forced by CNNA.
