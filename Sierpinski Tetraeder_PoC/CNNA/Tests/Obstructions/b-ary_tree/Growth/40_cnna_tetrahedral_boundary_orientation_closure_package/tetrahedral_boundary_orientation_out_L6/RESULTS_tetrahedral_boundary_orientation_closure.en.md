...
- A nonzero `axis_*_chirality_abs` would indicate genuine 3D/chiral orientation rather than parallel flat axes.
- Diagonal, trace, and common-mean reductions should eliminate the noncommutative K carrier.
- Symmetrized birth should suppress the dynamical amplitude if the carrier depends on growth asymmetry.
