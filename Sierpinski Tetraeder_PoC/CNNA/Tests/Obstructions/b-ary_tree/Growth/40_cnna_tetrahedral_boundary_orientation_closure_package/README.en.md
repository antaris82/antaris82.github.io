...
contains an oriented boundary / chirality / closure obstruction that is not visible
...
The primary output directories are `tetrahedral_boundary_orientation_out_L5/` and
