...
- Script 1/2: sequential birth, parent line + older siblings, directed sibling asymmetry, newborn as a later UV tail/backreaction for ancestors.
...
- New correction: Growth can be event-driven/nonlinear; a birth may trigger a complement-pairing cascade rather than a single linear local attachment.
