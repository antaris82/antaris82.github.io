# Real operator composition from a closed 2-sector gate
...
The package is a CNNA deterministic growing primal simplicial complex test. NGF/CQNM remains a comparison framework only.
