...
A positive result would require more than just local `J_pair^2=-I`: the actual Q/P channels
must be locked by the pair algebra, and the signed commutator should transform coherently
under the phase/kappa proxy while strict_sym remains deactivated.
