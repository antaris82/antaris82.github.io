...
It follows the real local operator calculus and 2D role-plane adjoint tests.  The purpose is to preserve the full 3-port DtN boundary structure for as long as possible, rather than immediately compressing each local cell into an Env/UV role plane.
