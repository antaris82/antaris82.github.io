...
- a newborn senses the parent line and older siblings;
- the newborn backreacts on the parent line and older siblings;
...
checks are significantly more computationally intensive than the previous live-only diagnostics.
