...
It checks whether the adjoint directions missing in the live-only 3-port test become visible after typing each local boundary space as record ⊕ live.
...
- fraction of T* all-ports residuals < 0.25: `0`
- fraction of T* block-envelope residuals < 0.25: `1`
- fraction of C* all-ports residuals < 0.25: `0`
- fraction of C* block-envelope residuals < 0.25: `1`
- mean metric condition number: `13.0340716765`
- mean metric minimum eigenvalue: `0.26756308083`
...
The test is positive only if the block-typed reverse operator system closes significantly better than the live-only reverse system. A small block-envelope residual but a large all-ports generated residual means that the adjoint resides in the typed block rank-one universe, but not yet in the actual growth-generated reverse handoff family.

If the closure improves, the next step is a finite, generated real operator system closure under addition, multiplication, and the block adjoint. If the closure remains weak, the boundary history space must be enriched beyond record/live blocks before attempting any J extraction.
