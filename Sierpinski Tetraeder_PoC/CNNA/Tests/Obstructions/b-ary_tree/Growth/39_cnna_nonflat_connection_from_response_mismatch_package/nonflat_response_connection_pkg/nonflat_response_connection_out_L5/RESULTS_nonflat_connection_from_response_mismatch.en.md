# Results: Nonflat connection due to same-label response mismatch

This test accepts identity/same-label face gluing and determines whether the remaining
DtN/response mismatch defines a nonflat connection involving double-history cycles.
...
SELECTED SUMMARIES
  ...
  double_history_suffix_cycle | real_growth | handoff | full | mean_face: count=39, valid=1.000, K=0.0001036, rawJ±=0.0005773, plane=0.0005773, amp=0.02587, metric=0.01211, Gcomm=1.55e-05, T=0.01213, metricWilson=1.802e-11, KWilson=5.718e-17, GcommWilson=9.011e-10, mixedWilson=0, hol=1.528e-15, hol_skew=5.942e-17, hol_complex=0.000, loopJ±=7.885e-16, transJ±=0.0005872, cond=1.618
  double_history_suffix_cycle | real_growth | aging | full | mean_face: count=39, valid=1.000, K=0.000100432, rawJ±=0.0006952, plane=0.0006951, amp=0.02577, metric=0.01208, Gcomm=1.632e-05, T=0.01211, metricWilson=1.741e-11, KWilson=5.014e-17, GcommWilson=8.703e-10, mixedWilson=0, hol=1.261e-15, hol_skew=5.213e-17, hol_complex=0.000, loopJ±=7.167e-16, transJ±=0.0007009, cond=1.615
