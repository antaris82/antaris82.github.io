...
The test separates the obstruction into families rather than treating the previous product algebra as a single black box.

Interpret the result in three layers:
