...
CNNA deterministic growing primal simplicial complex; provenance tree as birth-history; candidate sharp-closure obstruction diagnostic on the real C2 carrier; NGF/CQNM only as comparison, not as derivation source
