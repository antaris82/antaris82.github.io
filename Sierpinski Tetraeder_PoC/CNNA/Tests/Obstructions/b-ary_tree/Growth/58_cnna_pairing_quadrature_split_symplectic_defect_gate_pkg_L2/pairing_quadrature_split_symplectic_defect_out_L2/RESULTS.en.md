...
where R maps face b into the orientation-reversed gluing chart of face a.

The decisive question is whether P survives when Q is anticoherent / cancellation-prone.
A positive P channel is not proof of a creation-annihilation structure.  It is only a
derived real pre-structure that could later be tested for operator composition,
