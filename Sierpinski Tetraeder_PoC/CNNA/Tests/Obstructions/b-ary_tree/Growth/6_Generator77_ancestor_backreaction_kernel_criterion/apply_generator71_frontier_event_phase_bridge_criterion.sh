...
cp "$SRC_DIR/FrontierEventPhaseBridgeCriterion.lean" \
  "$TARGET_DIR/FrontierEventPhaseBridgeCriterion.lean"
cp "$SRC_DIR/GeneratorSpine.lean" \
  "$TARGET_DIR/GeneratorSpine.lean"
cp "$SRC_DIR/CLAIMS.md" \
  "$TARGET_DIR/GENERATOR_CLAIMS.md"

lake build CNNA.FrontierEventPhaseBridgeCriterion CNNA.GeneratorSpine
